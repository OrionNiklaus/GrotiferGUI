...
typedef struct _octave_Packet {
    ...
    bool has_angle;
    double angle; /* An optional floating-point field to hold the angle */
} octave_Packet;
...
X(a, STATIC,   OPTIONAL, DOUBLE,   angle,             2)
...
#define octave_Packet_size                       20

#ifndef PB_CONVERT_DOUBLE_FLOAT
/* Ensure that `double` is handled as `float` if required. */
